...
namespace sbnd
{
    ...
    class MCParticleAnalyser;
}
class sbnd::MCParticleAnalyser : public art::EDAnalyzer
{
public:
    explicit MCParticleAnalyser(fhicl::ParameterSet const &p);

    void analyze(art::Event const &e) override;
    void beginJob() override;

    MCParticleAnalyser(MCParticleAnalyser const &) = delete;
    MCParticleAnalyser(MCParticleAnalyser &&) = delete;
    MCParticleAnalyser &operator=(MCParticleAnalyser const &) = delete;
    MCParticleAnalyser &operator=(MCParticleAnalyser &&) = delete;
...
sbnd::MCParticleAnalyser::MCParticleAnalyser(fhicl::ParameterSet const &p)
    : EDAnalyzer{p},
...
void sbnd::MCParticleAnalyser::beginJob()
{
...
void sbnd::MCParticleAnalyser::analyze(art::Event const &e)
{
...
bool sbnd::MCParticleAnalyser::EntersDetector(float x, float y, float z)
{
...
DEFINE_ART_MODULE(sbnd::MCParticleAnalyser)
